    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white rounded-lg shadow-lg flex flex-col md:flex-row max-w-4xl w-full">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 text-center">
          <h1 className="text-orange-500 font-semibold text-2xl md:text-3xl mb-4">
            The Lotus Room
          </h1>
          ...
          {user ? (
            <div className="flex flex-col items-center">
              ...
              <button
                className="mt-4 bg-red-500 hover:bg-red-600 text-white px-5 py-2 rounded-lg transition duration-300"
